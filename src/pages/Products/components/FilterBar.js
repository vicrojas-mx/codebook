          ...
          <ul className="text-slate-700 dark:text-slate-100">
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input checked={state.sortBy === "lowtohigh" || false} onChange={() => dispatch({ type: "SORT_BY", payload: { sortBy: "lowtohigh" } })} id="price-sort-1" type="radio" value="" name="price-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                <label htmlFor="price-sort-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Price - Low to High</label>
              </div>
              <div className="flex items-center my-1">
                <input checked={state.sortBy === "hightolow" || false} onChange={() => dispatch({ type: "SORT_BY", payload: { sortBy: "hightolow" } })} id="price-sort-2" type="radio" value="" name="price-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input checked={state.ratings === "4STARSABOVE" || false} onChange={() => dispatch({ type: "RATINGS", payload: { ratings: "4STARSABOVE" } })} id="rating-sort-1" type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                <label htmlFor="rating-sort-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">4 Stars & Above</label>
              </div>
              <div className="flex items-center my-1">
                <input checked={state.ratings === "3STARSABOVE" || false} onChange={() => dispatch({ type: "RATINGS", payload: { ratings: "3STARSABOVE" } })} id="rating-sort-2" type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                <label htmlFor="rating-sort-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">3 Stars & Above</label>
              </div>
              <div className="flex items-center my-1">
                <input checked={state.ratings === "2STARSABOVE" || false} onChange={() => dispatch({ type: "RATINGS", payload: { ratings: "2STARSABOVE" } })} id="rating-sort-3" type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                <label htmlFor="rating-sort-3" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">2 Stars & Above</label>
              </div>
              <div className="flex items-center my-1">
                <input checked={state.ratings === "1STARSABOVE" || false} onChange={() => dispatch({ type: "RATINGS", payload: { ratings: "1STARSABOVE" } })} id="rating-sort-4" type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input checked={state.bestSellerOnly || false}
                   onChange={() => dispatch({ type: "BEST_SELLER_ONLY", 
              ...
              <div className="flex items-center my-1">
                <input checked={state.onlyInStock || false} onChange={() => dispatch({ type: "ONLY_IN_STOCK", payload: { onlyInStock: !state.onlyInStock } })} id="only-instock" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
